...
module Imported =
    ...
    module internal Delegate =
        ...
        let assume_default_colors = Platform.getDelegate<CInt_CInt_CInt> loader libPtr "assume_default_colors"
        ...
        let use_default_colors = Platform.getDelegate<CVoid_CInt> loader libPtr "use_default_colors"
...
//        let setsyx = Platform.getDelegate<CInt_CInt_CVoid> loader libPtr "setsyx"
    ...
    let assume_default_colors fg bg = Delegate.assume_default_colors.Invoke(fg, bg)
    ...
    let use_default_colors () = Delegate.use_default_colors.Invoke()
